...
> the team found these actions to not have a good effect on the team's effectiveness. Try to
> explain **why** these actions did not work well.

# Design updates

> If changes have been made to the overall design approach for the project, least the updates here. Link to documents (
> or updates to documents) that describe in detail what these changes are.
